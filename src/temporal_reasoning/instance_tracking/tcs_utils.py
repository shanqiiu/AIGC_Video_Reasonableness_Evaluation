...
GSAM_ROOT = ROOT / "third_party" / "Grounded-Segment-Anything"
GROUNDING_DINO_ROOT = GSAM_ROOT / "GroundingDINO"

for path in (GSAM_ROOT, GROUNDING_DINO_ROOT):
    if path.exists():
        str_path = str(path)
...
from GroundingDINO.groundingdino.util.utils import clean_state_dict, get_phrases_from_posmap  # type: ignore
