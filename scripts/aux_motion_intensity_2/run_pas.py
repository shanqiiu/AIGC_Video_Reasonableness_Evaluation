"""
基于 PAS（Perceptible Amplitude Score）的运动强度分析脚本
"""
...
def main():
    ...
    # 读取元信息
    print(f"从 {args.meta_info_path} 载入元数据...")
    with open(args.meta_info_path, 'r', encoding='utf-8') as f:
        meta_infos = json.load(f)
    
    print(f"共找到 {len(meta_infos)} 段待分析视频")
